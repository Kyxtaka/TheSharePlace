...
//import com.accountplace.api.security.CustomUserDetailsService;
...
//        UserDetails userDetails = customUserDetailsService.loadUserByUsername(userIdentifier);
        ...
        UserDetails userDetails = new User("randriantsoanathan1@gmail.com", "testHash", grantedAuthorities);
